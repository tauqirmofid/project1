...
public class StandaloneTasksAdapterOther extends RecyclerView.Adapter<StandaloneTasksAdapterOther.ViewHolder> {
    ...
    public StandaloneTasksAdapterOther(List<UniTask> tasks, OnTaskClickListener listener) {
        this.tasks = tasks;
