...
public class TasksAdapterOther extends RecyclerView.Adapter<TasksAdapterOther.TaskViewHolder> {
    ...
    public TasksAdapterOther(List<UniTask> taskList, OnTaskRemoveListener removeListener) {
        this.taskList = taskList;
        this.removeListener = removeListener;
    }

    // New constructor with both listeners
    public TasksAdapterOther(List<UniTask> taskList,
